...
1. 한 주에 한 챕터를 마무리 한다.
2. 한 챕터의 글을 한명씩 맡아 번역한다.
3. 화요일에 시작이고 월요일이 대드라인으로 느낀점/번역본을 공유한다.
4. 화요일에 번역할 챕터를 공유, 결정한다.
5. 모든 번역본은 [Wiki](https://github.com/Lee-hyuna/33-js-concepts-kr/wiki)에 작성한다.
7. 한 챕터를 건너뛰면 다른 분들에게 미안하다는 의미로 **1만원**의 벌금을 내도록 한다.
